    ...
    <div class="wrap">
        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                ...
                <li class="<?php
                if ($this->uri->uri_string() == 'jewellery') {
                    echo "active";
                }
                ?>"><a href="<?php echo base_url('/get/category/2'); ?>">Jewellery</a> </li>

                <li class="<?php
                if ($this->uri->uri_string() == 'dress') {
                    echo "active";
                }
                ?>"><a href="<?php echo base_url('/get/category/1'); ?>">Dress</a> </li>

                <li class="<?php
                if ($this->uri->uri_string() == 'accessories') {
                    echo "active";
                }
                ?>"><a href="<?php echo base_url('/get/category/3'); ?>">Bags & Accessories</a> </li>
